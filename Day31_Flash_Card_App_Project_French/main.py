...
# in front on flash card: WORD IN french
...
try:
    data=pandas.read_csv("Day31_Flash_Card_App_Project_French/data/words_to_learn.csv")
except FileNotFoundError:
    original_data=pandas.read_csv("Day31_Flash_Card_App_Project_French/data/french_to_english.csv")
    data_dict=original_data.to_dict(orient="records") 
else:
    # convert pandas dataframe to dictionary
    data_dict=data.to_dict(orient="records")    #in form of ("french":"word","english":"word_translation")
    # print(data_dict)

# button function
def next_card():
    # generate new french word:
    global current_card
    global flip_timer
    global data_dict
    ...
    canvas.itemconfig(current_language_text,text="French",fill="black")
...
def isKnown_card():
    ...
    data.to_csv("Day31_Flash_Card_App_Project_French/data/words_to_learn.csv",index=False)  #we do not wish to add indices to our new list so index=false
...
# import images:
right_image = PhotoImage(file="Day31_Flash_Card_App_Project_French/images/right.png")
wrong_image = PhotoImage(file="Day31_Flash_Card_App_Project_French/images/wrong.png")
back_image = PhotoImage(file="Day31_Flash_Card_App_Project_French/images/card_back.png")
front_image = PhotoImage(file="Day31_Flash_Card_App_Project_French/images/card_front.png")
...
# canvas text:
current_language_text=canvas.create_text(400,150,text="French",fill="black",font=("Ariel",40,"italic"))
